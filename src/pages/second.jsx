    ...
    <div className="bg-white rounded-xl shadow-lg w-full max-w-2xl p-6 relative overflow-y-auto max-h-[90vh]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
        <div>
          ...
          <p className="text-gray-900">#{selectedApplicant.id}</p>
        </div>

        <div>
          <p className="font-medium text-gray-700">Amount Needed</p>
          <p className="text-gray-900">{formatCurrency(selectedApplicant.amount_needed)}</p>
        </div>

        <div>
          <p className="font-medium text-gray-700">Tenor (Months)</p>
          <p className="text-gray-900">{selectedApplicant.tenor_in_months}</p>
        </div>

        <div>
          <p className="font-medium text-gray-700">Purpose</p>
          <p className="text-gray-900">{selectedApplicant.purpose || "N/A"}</p>
        </div>

        <div>
          <p className="font-medium text-gray-700">Status</p>
          <p className={`px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded-full ${getStatusColor(selectedApplicant.status)}`}>
        ...
        <div className="col-span-2 mt-4">
          <h3 className="font-semibold text-gray-800 mb-2 flex items-center">
            <Briefcase className="w-4 h-4 mr-2" /> Employment Details
          </h3>
          {selectedApplicant.employment_details ? (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <p className="font-medium text-gray-700">Employer</p>
                <p className="text-gray-900">{selectedApplicant.employment_details.employer_name || "N/A"}</p>
              </div>
              <div>
                <p className="font-medium text-gray-700">Office Email</p>
                <p className="text-gray-900">{selectedApplicant.employment_details.office_email || "N/A"}</p>
              </div>
              <div>
                <p className="font-medium text-gray-700">Employment Status</p>
                <p className="text-gray-900">{selectedApplicant.employment_details.employment_status || "N/A"}</p>
              </div>
              <div>
                <p className="font-medium text-gray-700">Monthly Income</p>
                <p className="text-gray-900">{formatCurrency(selectedApplicant.employment_details.monthly_income) || "N/A"}</p>
              </div>
            </div>
          ) : (
        ...
        <div className="col-span-2 mt-4">
          <h3 className="font-semibold text-gray-800 mb-2 flex items-center">
            <FileText className="w-4 h-4 mr-2" /> Next of Kin
          </h3>
          {selectedApplicant.next_of_kin ? (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <p className="font-medium text-gray-700">Name</p>
                <p className="text-gray-900">{selectedApplicant.next_of_kin.name}</p>
              </div>
              <div>
                <p className="font-medium text-gray-700">Phone</p>
                <p className="text-gray-900">{selectedApplicant.next_of_kin.phone}</p>
              </div>
              <div>
                <p className="font-medium text-gray-700">Relationship</p>
                <p className="text-gray-900">{selectedApplicant.next_of_kin.relationship}</p>
              </div>
            </div>
          ) : (
            <p className="text-gray-500">Next of kin: None</p>
          )}
        </div>
      </div>
    </div>
